...
(function (root, factory) {
  ...
  Blockly.BlockDragger.prototype.fireDragStartEvent_ = function () {
    var a = new Blockly.Events.BlockDrag(
      this.draggingBlock_,
      !0,
  ...
  Blockly.navigation.focusToolbox_ = function (a) {
    if ((a = a.getToolbox()))
  ...
  Blockly.navigation.focusFlyout_ = function (a) {
  ...
  Blockly.navigation.focusWorkspace_ = function (a) {
    Blockly.hideChaff();
    var b = a.getCursor(),
      c = !!a.getToolbox(),
      d = a.getTopBlocks(!0);
  ...
  Blockly.navigation.insertFromFlyout = function (a) {
    var b = a.getFlyout();
    if (b && b.isVisible()) {
      ...
      c.isEnabled()
        ? ((b = b.createBlock(c)),
          ...
          Blockly.navigation.focusWorkspace_(a),
  ...
  Blockly.navigation.disconnectBlocks_ = function (a) {
    var b = a.getCursor().getCurNode();
    if (b.isConnection()) {
      var c = b.getLocation();
      c.isConnected()
  ...
  Blockly.navigation.moveWSCursor_ = function (a, b, c) {
    var d = a.getCursor(),
      e = a.getCursor().getCurNode();
    ...
    d.setCurNode(
      Blockly.ASTNode.createWorkspaceNode(
        a,
        new Blockly.utils.Coordinate(
          b * Blockly.navigation.WS_MOVE_DISTANCE + e.x,
          c * Blockly.navigation.WS_MOVE_DISTANCE + e.y
        )
      )
    );
    return !0;
  };
  Blockly.navigation.handleEnterForWS_ = function (a) {
    a = a.getCursor().getCurNode();
    var b = a.getType();
    b == Blockly.ASTNode.types.FIELD
      ...
      callback: function (b, c, d) {
        switch (Blockly.navigation.currentState_) {
          case Blockly.navigation.STATE_WS:
            return b.getCursor().onBlocklyAction(d);
          case Blockly.navigation.STATE_FLYOUT:
            return Blockly.navigation.focusToolbox_(b), !0;
          case Blockly.navigation.STATE_TOOLBOX:
            return (b = b.getToolbox()) &&
              'function' == typeof b.onBlocklyAction
              ? b.onBlocklyAction(d)
              : !1;
          default:
            return !1;
      ...
      callback: function (b, c, d) {
        switch (Blockly.navigation.currentState_) {
          ...
          case Blockly.navigation.STATE_TOOLBOX:
            return (
              ((c = b.getToolbox()) &&
                'function' == typeof c.onBlocklyAction &&
                c.onBlocklyAction(d)) ||
                Blockly.navigation.focusFlyout_(b),
              !0
            );
          default:
            return !1;
  ...
  Blockly.navigation.registerInsert = function () {
    var a = {
      ...
      preconditionFn: function (b) {
        return b.keyboardAccessibilityMode && !b.options.readOnly;
      },
      callback: function () {
        switch (Blockly.navigation.currentState_) {
          case Blockly.navigation.STATE_WS:
  ...
  Blockly.navigation.registerMark = function () {
    var a = {
      ...
      callback: function (b) {
        switch (Blockly.navigation.currentState_) {
          case Blockly.navigation.STATE_WS:
            return Blockly.navigation.handleEnterForWS_(b), !0;
          case Blockly.navigation.STATE_FLYOUT:
            return Blockly.navigation.insertFromFlyout(b), !0;
          default:
            return !1;
        }
      },
  ...
  Blockly.navigation.registerDisconnect = function () {
    var a = {
      ...
      callback: function (b) {
        switch (Blockly.navigation.currentState_) {
          case Blockly.navigation.STATE_WS:
            return Blockly.navigation.disconnectBlocks_(b), !0;
          default:
            return !1;
        }
      },
      ...
      callback: function (b) {
        switch (Blockly.navigation.currentState_) {
          case Blockly.navigation.STATE_WS:
            return (
              b.getToolbox()
                ? Blockly.navigation.focusToolbox_(b)
                : Blockly.navigation.focusFlyout_(b),
              !0
            );
          default:
  ...
  Blockly.navigation.registerExit = function () {
    var a = {
      ...
      callback: function (b) {
        switch (Blockly.navigation.currentState_) {
          case Blockly.navigation.STATE_FLYOUT:
            return Blockly.navigation.focusWorkspace_(b), !0;
          case Blockly.navigation.STATE_TOOLBOX:
            return Blockly.navigation.focusWorkspace_(b), !0;
          default:
            return !1;
    ...
    Blockly.ShortcutRegistry.registry.register(a, !0);
    Blockly.ShortcutRegistry.registry.addKeyMapping(
  ...
  Blockly.navigation.registerWorkspaceMoveLeft = function () {
    var a = {
      ...
      preconditionFn: function (c) {
        return c.keyboardAccessibilityMode && !c.options.readOnly;
      },
      callback: function (c) {
        return Blockly.navigation.moveWSCursor_(c, -1, 0);
      },
    };
    Blockly.ShortcutRegistry.registry.register(a);
    var b = Blockly.ShortcutRegistry.registry.createSerializedKey(
  ...
  Blockly.navigation.registerWorkspaceMoveUp = function () {
    var a = {
      ...
      callback: function (c) {
        return Blockly.navigation.moveWSCursor_(c, 0, -1);
      },
    };
    Blockly.ShortcutRegistry.registry.register(a);
    var b = Blockly.ShortcutRegistry.registry.createSerializedKey(
  ...
  Blockly.Gesture.prototype.fireWorkspaceClick_ = function (a) {
    a = new Blockly.Events.Click(null, a.id, 'workspace');
    Blockly.Events.fire(a);
  };
  ...
  Blockly.Gesture.prototype.doBlockClick_ = function () {
    if (this.flyout_ && this.flyout_.autoClose)
      ...
      var a = new Blockly.Events.Click(
        this.startBlock_,
  ...
  Blockly.BlockSvg.prototype.select = function () {
    if (this.isShadow() && this.getParent()) this.getParent().select();
      ...
      a = new Blockly.Events.Selected(a, this.id, this.workspace.id);
      Blockly.Events.fire(a);
  ...
  Blockly.BlockSvg.prototype.unselect = function () {
    if (Blockly.selected == this) {
      var a = new Blockly.Events.Selected(this.id, null, this.workspace.id);
  ...
  Blockly.Events.ViewportChange = function (a, b, c, d) {
  ...
  Blockly.WorkspaceSvg.prototype.refreshTheme = function () {
    ...
    var a = new Blockly.Events.ThemeChange(this.getTheme().name, this.id);
    Blockly.Events.fire(a);
  };
  ...
  Blockly.WorkspaceSvg.prototype.maybeFireViewportChangeEvent = function () {
    if (Blockly.Events.isEnabled()) {
      ...
      (a == this.oldScale_ &&
        ...
        (this.oldTop_ = b),
        (this.oldLeft_ = c),
        (a = new Blockly.Events.ViewportChange(b, c, a, this.id)),
        Blockly.Events.fire(a));
    }
  };
  ...
  Blockly.Warning.prototype.setVisible = function (a) {
    a != this.isVisible() &&
      (Blockly.Events.fire(
        new Blockly.Events.BubbleOpen(this.block_, a, 'warning')
      ),
  ...
  Blockly.Comment.prototype.setVisible = function (a) {
    a != this.isVisible() &&
      (Blockly.Events.fire(
        new Blockly.Events.BubbleOpen(this.block_, a, 'comment')
      ),
  ...
  Blockly.Toolbox.prototype.attachEvents_ = function (a, b) {
    a = Blockly.bindEventWithChecks_(a, 'click', this, this.onClick_, !1, !0);
  ...
  Blockly.Toolbox.prototype.fireSelectEvent_ = function (a, b) {
    var c = a && a.getName(),
      d = b && b.getName();
    a == b && (d = null);
    a = new Blockly.Events.ToolboxItemSelect(c, d, this.workspace_.id);
    Blockly.Events.fire(a);
  };
  ...
  Blockly.Trashcan.prototype.fireUiEvent_ = function (a) {
    a = new Blockly.Events.TrashcanOpen(a, this.workspace_.id);
    Blockly.Events.fire(a);
  };
  ...
  Blockly.ZoomControls.prototype.fireZoomEvent_ = function () {
    var a = new Blockly.Events.Click(null, this.workspace_.id, 'zoom_controls');
    Blockly.Events.fire(a);
  };
  Blockly.Css.register([
  ...
  Blockly.Mutator.prototype.setVisible = function (a) {
    if (a != this.isVisible())
      if (
        (Blockly.Events.fire(
          new Blockly.Events.BubbleOpen(this.block_, a, 'mutator')
        ),
        a)
      ) {
        this.bubble_ = new Blockly.Bubble(
  ...
  Blockly.blockRendering.MarkerSvg.prototype.fireMarkerEvent_ = function (
    ...
    a = new Blockly.Events.MarkerMove(c, this.isCursor(), a, b);
    Blockly.Events.fire(a);
  };
